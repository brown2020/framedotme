...
| F-109 | P2 | Dependency | Done | Packages | Safe patch/minor updates and three majors were candidates; nested Next/PostCSS audit remained. Two manifest dependencies had no source/config use. | Final install/audit/tree/build; TypeScript 7 incompatibility reproduction | Removed unused deps, updated every compatible package including Firebase Admin 14, overrode nested PostCSS, and documented TypeScript 7 deferral. |
